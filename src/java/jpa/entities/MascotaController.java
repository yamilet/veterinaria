...
import jpa.sessions.MascotaFacade;
...
@ManagedBean(name = "mascotaController")
@SessionScoped
public class MascotaController implements Serializable {
    ...
    @EJB
    private jpa.sessions.MascotaFacade ejbFacade;
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/properties/Bundle-location").getString("MascotaCreated"));
            return prepareCreate();
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/properties/Bundle-location").getString("PersistenceErrorOccured"));
            return null;
        }
    }
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/properties/Bundle-location").getString("MascotaUpdated"));
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/properties/Bundle-location").getString("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/properties/Bundle-location").getString("MascotaDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/properties/Bundle-location").getString("PersistenceErrorOccured"));
        }
    }
